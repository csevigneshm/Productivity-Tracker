    ...
    return (
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4 sm:p-6">
                ...
                <Link
                    href="/applications"
                    className="flex w-fit items-center gap-1.5 text-sm text-neutral-400 hover:text-neutral-700 dark:hover:text-neutral-200"
                >
                ...
                <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                    <div className="flex flex-wrap items-start justify-between gap-4">
                        ...
                        <select
                            ...
                            className={`rounded-full border-0 px-3 py-1 text-xs font-semibold capitalize focus:ring-2 focus:ring-neutral-900/20 focus:outline-none ${STATUS_COLORS[app.status] ?? ''}`}
                        >
                            {[
                                'applied',
                                'shortlisted',
                ...
                <div className="flex flex-1 flex-col rounded-2xl border border-neutral-200 bg-white dark:border-neutral-700 dark:bg-neutral-900">
                    ...
                    <div className="flex flex-1 flex-col gap-3 overflow-y-auto p-5">
                        {comments.length === 0 ? (
                            ...
                            comments.map((c) => (
                                <div
                                    key={c.id}
                                    className="group flex flex-col gap-1 rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 dark:border-neutral-800 dark:bg-neutral-800/50"
                                >
                                    {editingId === c.id ? (
                                        <div className="flex gap-2">
                                            <textarea
                                                ...
                                                rows={2}
                                                className="flex-1 resize-none rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm focus:ring-2 focus:ring-neutral-900/20 focus:outline-none dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-200"
                                            />
                    ...
                    {/* add comment input */}
                    {error && (
                        <p className="px-5 text-xs text-rose-500">{error}</p>
                    )}
                    <div className="flex gap-3 border-t border-neutral-100 p-4 dark:border-neutral-800">
                        <textarea
                            ...
                            rows={2}
                            className="flex-1 resize-none rounded-xl border border-neutral-200 bg-neutral-50 px-4 py-2.5 text-sm text-neutral-700 focus:ring-2 focus:ring-neutral-900/20 focus:outline-none dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200 dark:placeholder-neutral-500"
                        />
                        <button
