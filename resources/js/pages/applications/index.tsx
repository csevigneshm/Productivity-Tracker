    ...
    return (
        <div className="flex flex-col gap-1">
            ...
            <select
                ...
                className="rounded-xl border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-700 focus:ring-2 focus:ring-neutral-900/20 focus:outline-none dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-200"
            >
                {options.map((o) => (
...
function CommentsCell({
    ...
    const handleDelete = async (id: number) => {
        await apiFetch(`/api/applications/comments/${id}`, {
            method: 'DELETE',
        });
        onRefresh();
    };
        ...
        <div className="flex flex-col gap-2">
            <div className="flex items-center gap-1.5">
                <input
                    ...
                    className="flex-1 rounded-lg border border-neutral-200 bg-white px-2.5 py-1.5 text-xs text-neutral-700 placeholder-neutral-300 focus:ring-2 focus:ring-neutral-900/20 focus:outline-none dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200 dark:placeholder-neutral-600"
                />
                <button
                    onClick={handleSend}
...
export default function ApplicationsIndex() {
    ...
    const filtered = useMemo(() => {
        ...
        return result;
    }, [applications, filterStatus, filterSource, filterType]);
    ...
    const f = (key: keyof typeof emptyForm) => (v: string) =>
        setForm((p) => ({ ...p, [key]: v }));
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4 sm:p-6">
                ...
                {showForm && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4 backdrop-blur-sm">
                        <div className="w-full max-w-lg rounded-2xl border border-neutral-200 bg-white p-6 shadow-xl dark:border-neutral-700 dark:bg-neutral-900">
                            ...
                            {error && (
                                <p className="mb-3 rounded-lg bg-rose-50 px-3 py-2 text-sm text-rose-600 dark:bg-rose-950/40 dark:text-rose-400">
                                    {error}
                                </p>
                            )}
                ...
                {loading ? (
                    ...
                    <>
                            ...
                            {filtered.map((app) => (
                                ...
                                >
                                    ...
                                    <div className="mb-3 flex flex-wrap items-center gap-2">
                                        <Badge
                                            label={app.type}
                                            className={TYPE_COLORS[app.type]}
                                        />
                                        <select
                                            value={app.status}
                                            onChange={(e) =>
                        ...
                        {/* Desktop table */}
                        <div className="hidden overflow-x-auto rounded-2xl border border-neutral-200 sm:block dark:border-neutral-700">
                                ...
                                <thead>
                                    <tr className="border-b border-neutral-200 bg-neutral-50 text-left dark:border-neutral-700 dark:bg-neutral-800/50">
                                        {[
                                            ...
                                            <th
                                                key={h}
                                                className="px-4 py-3 text-xs font-semibold tracking-wide text-neutral-400 uppercase dark:text-neutral-500"
                                            >
                                                {h}
                                            </th>
                                        ))}
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3 text-neutral-600 capitalize dark:text-neutral-400">
                                                <select
                                                    ...
                                                    className="rounded-full border-0 bg-transparent px-1 py-0.5 text-xs font-medium text-neutral-600 capitalize focus:ring-2 focus:ring-neutral-900/20 focus:outline-none dark:text-neutral-400"
                                                >
                                                    {[
                                                        'linkedin',
                                                        'naukri',
                                            ...
                                            <td className="px-4 py-3">
                                                <select
                                                    ...
                                                    className={`rounded-full border-0 px-2.5 py-0.5 text-xs font-semibold capitalize focus:ring-2 focus:ring-neutral-900/20 focus:outline-none ${STATUS_COLORS[app.status]}`}
                                                >
                                                    {[
                                                        'applied',
                                                        'shortlisted',
                                            ...
                                            <td className="max-w-xs min-w-[220px] px-4 py-3 align-top">
                                                <CommentsCell
                                                    appId={app.id}
                                                    comments={[
                                                        ...app.application_comments,
